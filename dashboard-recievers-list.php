                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-3">
                            ...
                            <div class="btns">
                                <a class="btn btn-primary" href="#add-reciever-popup" data-animation="fadein" data-plugin="custommodal" data-overlayColor="#36404a"> <i class="fa fa-plus"></i> Add New Reciever </a>
                                <a class="btn btn-custom1" href="#"> Export </a>

                                <!-- Modal -->
                                <div id="add-reciever-popup" class="modal-demo modal-sm ">
                                    ...
                                    <div class="custom-modal-text">
                                        ...
                                        <p> These rows will be permanently deleted and can not be covered. Confirm Delete? </p>
