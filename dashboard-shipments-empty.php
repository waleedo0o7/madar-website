                        ...
                        <div class="dashboard-search-page">
                                ...
                                <div class=" info-box company-info-content p-5">
                                    <div class="recievers d-flex align-items-center justify-content-center flex-direction-column">
                                        <img style="max-width: 280px;" class="img-fluid" src="assets/images/empty.png">
                                        <h4> No search results found </h4>
                                        <p class="mb-1">  There may me no shipments associated with this name or the name is incorrect.  </p>
                                        <div class=" btns d-flex align-items-center justify-content-center">
                                            <a style="width: 300px;" class="btn btn-block btn-custom1" href="#"> Clear </a>
                                        </div>
                                    </div>
                                </div> <!-- card-box -->
