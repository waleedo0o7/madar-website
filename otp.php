                ...
                <div class="col-lg-6 d-flex align-items-start justify-content-center left vh-100">
                    ...
                    <div class="page-content ">
                        ...
                        <div class="otp">
                            ...
                            <p class="mb-3"> please enter the 4-digits one time password sent to 012457888 </p>
                            <!--  -->

                            <form>
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <input class="form-control" type="text" id="digit1">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <input class="form-control" type="text" id="digit2">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <input class="form-control" type="text" id="digit3">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <input class="form-control" type="text" id="digit4">
                                    </div>
                                </div>
