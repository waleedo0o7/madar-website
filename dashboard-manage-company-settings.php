                        ...
                        <h3 class="mb-3"> Company Settings </h3>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="company-logo-container mb-3">
                                        <img class="img-fluid logo" src="assets/images/logo01.png">
                                    </div>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col one-info mb-0">
                                            <p> Logo </p>
                                            <img style="width: 200px;" class="img-fluid" src="assets/images/logo02.png">
                                        </div>
                                        <div class=" col one-info mb-0">
                                            <p> Color </p>
                                            ...
                                            <div class="all-colors d-flex align-items-center">
                                                ...
                                                <div class="one-color main-color" style="background-color: #01579b;width: 60px; height: 60px;"></div>
