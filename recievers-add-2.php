                                ...
                                <div class="card-box info-box company-info-content">
                                    ...
                                    <div style="height: 100%;" class="d-flex flex-direction-column justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <div class="short-data short-data-add-reciever">
                                                <h4 style="margin-bottom: 0px"> Saudi Aramco 1 </h4>
                                                <div class="one-info">
                                                    <label> Conatct Person </label>
                                                    <p style="margin-bottom: 0px"> Dusya Sigachyova </p>
                                                </div>

                                                <div class="one-info">
                                                    <label> Phone Number </label>
                                                    <p style="margin-bottom: 0px"> 262-616-8927 </p>
                                                </div>
                                            </div>
