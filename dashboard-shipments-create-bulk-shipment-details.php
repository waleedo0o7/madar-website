                    ...
                    <div class="container-fluid">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-3">
                                <h3 class="mb-3"> Upload Bulk Shipment </h3> 
                                        ...
                                        <!-- Modal -->
                                        <div id="detials" class="modal-demo">
                                            <button type="button" class="close" onclick="Custombox.modal.close();">
                                                <span>&times;</span><span class="sr-only">Close</span>
                                            </button>
                                            <h4 class="custom-modal-title"> #10858 - OB Details </h4>
                                ...
                                <div class="card-box padding0" style="border: 1px solid #e4e9f3;"> 
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tr> 
                                                <td>  <a href="#detials" data-animation="fadein" data-plugin="custommodal" data-overlayColor="#36404a">  #10858 - OB  </a>  </td>
                                                <td> Canon Compan…</td>
                                                <td> Fugji Limited in.. </td>
                                                <td> 1230 M2 </td>
                                                <td> 3215 KG </td>
                                                <td> 15 May 2020, 12:00 PM </td> 
                                                <td> <p class="green"> <i class="fa fa-check"></i> No Errors</p> </td> 
                                            </tr>
                                            ...
                                            <tr> 
                                                ...
                                                <td> 3215 KG </td>
                                                <td> 15 May 2020, 12:00 PM </td> 
                                                <td> <p class="red"> <i class="fa fa-times"></i> Reciver company not found</p> </td> 
                                            </tr>
                                    ...
                                    <div class="m-3">
                                        ...
                                        <div class=" d-flex align-items-center justify-content-between mt-3">
                                                <a class="btn btn-custom1" href="#"> Cancel </a>
                                            <div>
                                                <a class="btn btn-custom1" href="#"> Back </a>
